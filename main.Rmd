...
stargazer(L1, L2, L3,digits = 2,title = "Regression results for each country", type = 'latex')
```
...
stargazer(pooled, fixed,digits = 3,title = "pooled OLS and fixed effects OLS", type = 'latex')
