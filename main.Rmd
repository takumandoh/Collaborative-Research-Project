...
According to Table 2, each country has different values of coefficients and significant levels for explanatory variables. For example, in South Africa, gdppc has a negative effect on the degree of democratization, while gdppc has a positive effect in Botswana. In Kenya, gdppc is not even statistically significant. This means that the effectiveness of GDP per capita on the degree of democracy is different across countries. 
