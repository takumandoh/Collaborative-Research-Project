...
$$polity4 = \beta_0 + \beta_1\log{gdppc}+\beta_2\log{pe}+\beta_3\log{mr}+\beta_4\log{gi}  $$
...
Apparently, the residuals depends on x values. This means that there are country specific effects on residuals. Therefore, the coefficients are not efficient and unbiased. Then, we will run Breusch-Pegan test to clearlify whether the country specific effects really exists.
